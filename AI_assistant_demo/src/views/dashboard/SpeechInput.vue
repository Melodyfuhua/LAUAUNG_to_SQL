  ...
  <div class="container">
    ...
    <div class="row inputs-row">
      ...
      <div class="input-section">
        ...
        <button class="idle" @click="submitManualQuery">提交</button>
      </div>

      <!-- 语音输入 -->
      <div class="input-section">
        <label>请语音输入SQL提示词：</label>
        <textarea v-model="voiceInputText" placeholder="语音输入的文本"></textarea>
        <button
...
export default {
  ...
  methods: {
    ...
    toggleRecording() {
      ...
      if (this.isRecording) {
        // 保存当前文本
        this.originalText = this.voiceInputText;
        // 重置当前录音识别的文本
        ...
        if ('SpeechRecognition' in window || 'webkitSpeechRecognition' in window) {
          ...
          this.recognition.onresult = (event) => {
            ...
            // 更新文本框内容：原文 + 当前识别的文本
            this.voiceInputText = this.originalText + 
        ...
        if (this.recognition) {
          ...
          // 更新原始文本，包含这次录音的结果
          this.originalText = this.voiceInputText;
          this.generateQuery(this.voiceInputText);;
        }
      }
    },
